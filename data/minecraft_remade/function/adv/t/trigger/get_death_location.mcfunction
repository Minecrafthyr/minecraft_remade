...
{ \
  "translate": "minecraft_remade.get_death_location.teleport", "fallback": "Last Death Location: Dimension %s, Pos %s (Click to teleport)","clickEvent": {"action": "run_command","value": "/function minecraft_remade:func/trigger/back_to_death_location/tp"}, \
